...
public class EnemyBowAi : MonoBehaviour
{
    ...
    //gaseste playerul
        ...
        if (enemy != null)
        {
            ...
            //Vector3 direction = ((enemy.position - down) - transform.position).normalized;
           ...
           // Quaternion targetRotation = Quaternion.LookRotation(direction);
            ...
            if (timer > 0)
            {
                //daca a atacat doar se misca putin
    ...
    public void SearchPoint()
    {
        ...
        //cauta cel mai apropriat punct de navMesh
